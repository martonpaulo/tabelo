import { cellText } from "./cell-value";
...
export interface SamplePerson {
	...
	// The roster states this type explicitly. Nothing derives it from text.
	readonly age: number;
}
...
export function samplePeopleMatrix(rows = samplePeople.length): CellValue[][] {
	return [
		[...samplePeopleHeaders],
		...samplePeople
			.slice(0, rows)
