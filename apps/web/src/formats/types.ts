...
export type ParseIssue =
	...
	| ({ readonly code: "json-object-shape-required" } & LocatedParseIssue)
	| ({ readonly code: "json-columns-array-required" } & LocatedParseIssue)
	| ({ readonly code: "json-rows-array-required" } & LocatedParseIssue)
