...
then sits under the question; the grid's fill handle on a pinned row or column
is placed by a scroll listener and so trails a scroll by a frame; and the
source view's pinned header appears one frame after the real header has begun
to leave.
