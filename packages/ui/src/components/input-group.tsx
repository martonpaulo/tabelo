...
const inputGroupButtonVariants = cva(
	"flex items-center gap-2 text-xs shadow-none",
	{
		variants: {
			size: {
				xs: "h-6 gap-1 rounded-interactive px-1.5 [&>svg:not([class*='size-'])]:size-3.5",
				sm: "h-7 gap-1 rounded-interactive px-2",
				"icon-xs": "size-6 rounded-interactive p-0 has-[>svg]:p-0",
				"icon-sm": "size-7 rounded-interactive p-0 has-[>svg]:p-0",
			},
		},
		defaultVariants: {
			size: "xs",
